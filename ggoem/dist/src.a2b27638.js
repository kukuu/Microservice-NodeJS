...
*/
var one = "https://ft-tech-test-example.s3-eu-west-1.amazonaws.com/ftse-fsi.json";
var two = "https://ft-tech-test-example.s3-eu-west-1.amazonaws.com/gbp-hkd.json";
var three = "https://ft-tech-test-example.s3-eu-west-1.amazonaws.com/gbp-usd.json";

var requestOne = _axios.default.get(one);

var requestTwo = _axios.default.get(two);

var requestThree = _axios.default.get(three);

_axios.default.all([requestOne, requestTwo, requestThree]).then(_axios.default.spread(function () {
  var responseOne = arguments.length <= 0 ? undefined : arguments[0];
  var responseTwo = arguments.length <= 1 ? undefined : arguments[1];
  var responesThree = arguments.length <= 2 ? undefined : arguments[2]; // results
