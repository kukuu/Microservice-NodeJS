...
The micro-service  applications capable of running in their own memory space and scale independently from each other across potentially many separate machines. 
